...
public class OTPValidation {
	...
	public static void main(String[] args) throws IOException{
		String url = "http://otpm.kokatto.com/v2/otpm/validation/";
		URL obj = new URL(url);
		...
		String appType = "APP-TYPE";
		String requestId = "YOUR-REQUEST-ID";
		String otpmCode = "YOUR-OTPM-CODE";
		...
		String urlParameters = "clientId=" + clientId + "&appType=" + appType + "&requestId=" + requestId + 
				"&otpmCode=" + otpmCode + "&timestamp=" + timeStamp + 
				"&signature=" + signature;
